...
export default function Header({ onAuthRequired, onMenuStateChange }: HeaderProps) {
  ...
  const handleSignOut = async () => {
    try {
      ...
      toast({
        ...
        description: t('auth.signOut.errorDetail'),
        variant: 'destructive'
      });
    }
  };
  ...
  return (
    <>
      <header className="bg-red-700 text-white h-16 fixed top-0 left-0 right-0 z-40">
